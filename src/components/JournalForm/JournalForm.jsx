...
function JournalForm({onSubmit, data, onDelete}) {
  ...
  return (
          <form className={styles['journal-form']} id={'journal-form'} onSubmit={addJournalItem}>
         ...
         <div className={styles['form-row']}>
           ...
           <Input type='text' ref={tagRef} isValid={isValid.tag} onChange={onChange} value={values.tag} name='tag' id='tag'/>
         </div>

        <textarea ref={postRef} name="post" id="" onChange={onChange} value={values.post} cols={30} rows={10} className={!isValid.post ? styles['invalid'] : ''}></textarea>
